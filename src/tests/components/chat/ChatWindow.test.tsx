...
describe("ChatWindow", () => {
    ...
    it("displays a welcome message when there are no messages", () => {
        ...
        expect(screen.getByText("How can I assist you with Two Sum problem?")).toBeInTheDocument();
    });
    ...
    it("shows API key message when apiKey is not set", () => {
        ...
        expect(screen.getByText("Please set your Gemini API key in the extension settings.")).toBeInTheDocument();
    });
});
